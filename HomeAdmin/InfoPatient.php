                ...
                <form>
                    <div class="form-row">
                        <div class="col-lg-4 col-sm-4">
                            <input type="text" value="<?php echo $cin ?>" disabled class="form-control my-2 p-2">
                        </div>
                        <div class="col-lg-4 col-sm-4">
                    ...
                    <div class="form-row">
                        <div class="col-lg-6 col-sm-6">
                            <input type="password" id="pass" value="<?php echo $pass ?>" disabled class="form-control my-2 p-2">
                        </div>
                    ...
                    <div class="form-row">
                        <div class="col-lg">
                            <button class="btn btn-primary my-2 p-2"><a href="ListPatients.php" class="text-light">Retour</a></button>
                        </div>
                    </div>
                </form>
            </div>
